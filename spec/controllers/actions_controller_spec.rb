  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved action as @action" do
        ...
        post :create, {:action => { "title" => "invalid value" }}, valid_session
        assigns(:action).should be_a_new(Action)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested action" do
        ...
        Action.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => action.to_param, :action => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the action as @action" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Action.any_instance.stub(:save).and_return(false)
        put :update, {:id => action.to_param, :action => { "title" => "invalid value" }}, valid_session
        assigns(:action).should eq(action)
      end
