...
describe "ecosystem_assessments/new" do
  before(:each) do
    assign(:ecosystem_assessment, stub_model(EcosystemAssessment,
      :type => "",
      :title => "MyString",
      :language => "MyString",
  ...
  it "renders new ecosystem_assessment form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", ecosystem_assessments_path, "post" do
