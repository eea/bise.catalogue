...
describe "protected_areas/new" do
  before(:each) do
    assign(:protected_area, stub_model(ProtectedArea,
      :code => 1,
      :uri => "MyString",
      :name => "MyString",
      :designation_year => 1,
  ...
  it "renders new protected_area form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", protected_areas_path, "post" do
